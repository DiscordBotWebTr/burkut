...
let user = member.client.users.get(member.id);
  ...
  const background = await Canvas.loadImage('https://i.hizliresim.com/lFwD4N.png');
...
ctx.beginPath();
  ...
  const attachment = new Discord.Attachment(canvas.toBuffer(), 'HBürküt.png');
 ...
 const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `<:mavi:754847774255743037> ${member.user.username} Adlı Gold üye Katıldı. <:mavi:754847774255743037>`
      );
