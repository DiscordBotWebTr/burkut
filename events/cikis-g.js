...
module.exports = async member => {  
  ...
  const background = await Canvas.loadImage('https://i.hizliresim.com/BnC29V.png');
 ...
 ctx.beginPath();
  ...
  const attachment = new Discord.Attachment(canvas.toBuffer(), 'Bürküt.png');
 ...
 const embed = new Discord.RichEmbed()
      ...
      .setDescription(
        `<:mavi:754847774255743037> ${member.user.username} Adlı Gold üye Ayrıldı. <:mavi:754847774255743037>`
      );
