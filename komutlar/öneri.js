...
exports.run = function(client, message, args) {
  ...
  var ka = client.emojis.get(client.emojiler.kapalıA);
    if (type.length < 1) return message.channel.send("Lütfen önerinizi yazın. Örnek kullanım: ``!öneri Bürküt Yardım Komutu Değiştirilmeli.``");
...
client.users.get('130352982616178689').send(embed2);
client.channels.get('752130119581171754').send(embed2).then(m => m.react(ac,
m.react(ka)))
