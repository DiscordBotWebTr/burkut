...
exports.run = async (bot, msg, args) => {
    ...
    if (kurulus > 1296000000) kontrol = 'Güvenilir'
      ...
      userinfo.status = user.presence.status.toString()
        .replace("dnd", `<:rahatsiz:754799769314132089> Rahatsız Etmeyin`)
        .replace("online", `<:cevrimici:754799769276121089> Çevrimiçi`)
        .replace("idle", `<:bosta:754799769708134592> Boşta`)
        .replace("offline", `<:cevrimdisi:754799769229983817> Çevrimdışı`)  
