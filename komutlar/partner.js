...
if (check == 1) {
    ...
    if(message.member.roles.has('754801932161253398') === true) return message.channel.send(`Zaten \`Partner\` rolün bulunuyor fazlasını ne yapacaksın`)
...
.setTimestamp()
  ...
  message.member.addRole('754801932161253398')
