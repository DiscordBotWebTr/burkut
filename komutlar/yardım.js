...
const footer = `[${dil.special.botinvite}](https://discordapp.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=8) | [${dil.special.supportserver}](https://discord.com/invite/gSgjSxk) | [${dil.special.DBLpage}](${client.ayarlar.webpanel})\n \`DiscordBot.Web.TR\``;
